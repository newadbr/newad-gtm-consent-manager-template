# Newad Consent Manager

## Overview (EN)
Consent template to set Google Consent Mode defaults and updates, with optional Newad banner injection.

This variant is the baseline manager and supports embedded banner flow (enableBanner default = true).
...
2. Search for **Newad Consent Manager** in Community Template Gallery.
...
## Visao Geral (PT-BR)
Template de consentimento para definir estados default e update do Google Consent Mode, com injecao opcional de banner Newad.

Esta variante e o gerenciador base e suporta fluxo com banner embutido (enableBanner default = true).
...
2. Busque **Newad Consent Manager** na Community Template Gallery.
